---
title: "GN02: Payment means and use of the UNCL4461 code list"
---
...
📄 File available for download [here](https://raw.githubusercontent.com/A-NZ-PEPPOL/Guidance-documents/markdown/pdf/GN02_Payment%20means%20and%20use%20of%20the%20UNCL4461%20code%20list.pdf)
...
<cac:PaymentMeans> <!-- Domestic credit transfer -->
  ...
  <cbc:PaymentID>88827661226</cbc:PaymentID> <!-- customer reference number -->
  <cac:PayeeFinancialAccount>
    <cbc:ID>0205000632487000</cbc:ID> <!-- Combined NZ Bank/Branch/Account Number -->
    <cbc:Name>ABC Ltd.</cbc:Name> <!-- Account name -->
  </cac:PayeeFinancialAccount>
</cac:PaymentMeans>
```
...
| Version | Date           | Change |
|---------|----------------|--------|
| 1.0    | 09/10/2019      | Initial published version |
| 1.1    | 15/05/2020      | Updated sections that refer to New Payment Platform (NPP). Included minor editorial corrections and for `cbc:PaymentMeans` element group. Included additional example for Direct Debit. |
| 1.2    | 23/09/2021      | Editorial changes for clarification. Included additional information for scenarios:<br>• NPP – PayID types, PayTo functionality<br>• Use of NZ bank account number<br>• Payment URL<br>• Credit Card payment |
| 1.3    | 21 November 2022 | Updated document classification. |
| 1.4    | 09 December 2024 | Updated artefact references to the PINT A-NZ specification. Editorial changes for clarification. |
| 1.5    | 09 June 2025     | Updated Credit Transfer section to include information on Confirmation of Payee verification |
