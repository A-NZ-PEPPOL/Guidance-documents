---
title: "GN01: Including WET and LCT on an Invoice"
---
...
📄 Copy available for download [here]( https://raw.githubusercontent.com/A-NZ-PEPPOL/Guidance-documents/markdown/pdf/GN01_Including%20WET%20and%20LCT%20on%20an%20Invoice.pdf)
...
Refer to [**Appendix A**](#appendix-a--wine-equalisation-tax-example) for detailed examples.
...
- Put the amount in UBL element `cac:InvoiceLine/cbc:LineExtensionAmount` ([IBT-131](https://docs.peppol.eu/poac/aunz/pint-aunz/trn-invoice/semantic-model/ibt-131/)).
...
Refer to [**Appendix B**](#appendix-b--luxury-car-tax) for detailed examples.
...
> *\*(33%) × 10/11 × [Luxury car tax value – luxury car tax threshold]*
...
<cac:InvoiceLine> <!-- Additional line item for stamp duty, registration fees etc -->
    ...
    <cac:Item>
        ...
        <cac:CommodityClassification>
            <cbc:ItemClassificationCode listID="ZZZ">Stamp Duty</cbc:ItemClassificationCode> <!-- Recommended LCT code for automation of processing -->
        </cac:CommodityClassification>
        <cac:ClassifiedTaxCategory>
            <cbc:ID>E</cbc:ID>
            <cbc:Percent>0</cbc:Percent>
